//! This is a fork of <https://github.com/terhechte/postsack/blob/main/ps-gui/src/widgets/table.rs>

use std::ops::Range;
use std::{fmt::Display, hash::Hash};

use eframe::egui::{vec2, FontId, Id, Response, ScrollArea, Sense, Ui, Vec2, Widget};
    ...
    > Table<'s, R, C, RowMaker, RowSelection>
{
    ...
    fn header_ui(&mut self, ui: &mut Ui) {
        ...
        for (i, column) in self.columns.iter().enumerate() {
            ...
            let galley =
                ui.fonts()
                    .layout_no_wrap(column.name.clone(), FontId::proportional(10.0), color);
    ...
    fn ui(mut self, ui: &mut Ui) -> Response {
        ...
        ScrollArea::vertical().show_rows(ui, self.row_height, self.num_rows, |ui, row_range| {
            ui.scope(|ui| {
                ...
                let cell_text_style = FontId::proportional(10.0); //ui.style().body_text_style;
                let column_len = self.columns.len();
